...
function About() {
  return (
    <section className="about-enter min-h-screen bg-[#f5f6f0] px-4 pb-10 pt-28 vault-grid sm:px-6 sm:pb-16 sm:pt-36 lg:pt-64 xl:pt-72">
      <div className="mx-auto max-w-5xl">
        <div className="relative border-4 border-[#f9d1d9] bg-[#fffdf8] px-5 py-8 shadow-[7px_7px_0_rgba(131,143,88,0.45)] sm:px-14 sm:py-14 sm:shadow-[12px_12px_0_rgba(131,143,88,0.45)]">
          ...
          <h1 className="mt-4 break-words font-mono text-3xl font-black uppercase tracking-[0.12em] text-slate-800 sm:text-4xl sm:tracking-[0.14em]">
            ForSixteen
          </h1>

          <div className="mt-8 max-w-3xl space-y-5 font-serif text-xl leading-8 text-slate-700 sm:text-2xl sm:leading-10">
            <p>
          ...
          <p className="mt-12 border-t border-slate-200 pt-6 font-mono text-xs font-bold uppercase leading-6 tracking-[0.16em] text-slate-400 sm:tracking-[0.18em]">
